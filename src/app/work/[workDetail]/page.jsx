...
const WorkDetail = () => {
  ...
  const allImages = [workItem.img, ...workItem.images.map((img) => eval(img))]; // Combine main and gallery images
  ...
  return (
    <div className="container py-12 px-4 mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-8">
        {workItem.images.map((imageName, index) => {
          const imageSrc = eval(imageName);
          return (
